...
public class SubqueriesTest extends EntityManagerTest {
	...
	public void pesquisarComAny() {
	    ...
	    // Todos os produtos que já foram vendidos por um preco diferente do atual. ANY(Qualquer)
	    String jpql = "select p from Produto p " +
	    		" where p.preco <> ANY (select precoProduto from ItemPedido where produto = p)";
	    
	    // Todos os produtos que já foram vendidos por um preco diferente do atual SOME(Algum)
	    //String jpql = "select p from Produto p " +
