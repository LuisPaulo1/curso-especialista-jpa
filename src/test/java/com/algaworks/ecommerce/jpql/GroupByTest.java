...
//        Total de vendas por cliente
	...
	public void agruparResultado() {
	    ...
	    //Total de vendas por cliente
		//String jpql = "select ip.pedido.cliente.nome as nome, sum(ip.precoProduto * ip.quantidade) from ItemPedido ip group by nome";
	    String jpql = "select c.nome, sum(ip.precoProduto * ip.quantidade) from ItemPedido ip join ip.pedido p join p.cliente c group by c.id";
