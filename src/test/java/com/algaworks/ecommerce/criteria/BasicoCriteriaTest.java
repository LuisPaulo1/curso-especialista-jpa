...
public class BasicoCriteriaTest extends EntityManagerTest {
    ...
    public void ordenarResultados() {
        ...
        criteriaQuery.orderBy(criteriaBuilder.asc(root.get("id")), criteriaBuilder.desc(root.get("nome")));
    ...
    public void retornarTodosOsProdutosExercicio() {
        ...
        CriteriaBuilder criteriaBuilder = entityManager.getCriteriaBuilder();
        CriteriaQuery<Produto> criteriaQuery = criteriaBuilder.createQuery(Produto.class); //O tipo de retorno da query
        Root<Produto> root = criteriaQuery.from(Produto.class);

        criteriaQuery.select(root); //opcional. O padrão retornar o root        
    ...
    public void selecionarUmAtributoParaRetorno() {
        ...
        CriteriaBuilder criteriaBuilder = entityManager.getCriteriaBuilder();
        CriteriaQuery<BigDecimal> criteriaQuery = criteriaBuilder.createQuery(BigDecimal.class); //O tipo de retorno da query
        Root<Pedido> root = criteriaQuery.from(Pedido.class);
    ...
    public void buscarPorIdentificador() {
        ...
        CriteriaBuilder criteriaBuilder = entityManager.getCriteriaBuilder();
        CriteriaQuery<Pedido> criteriaQuery = criteriaBuilder.createQuery(Pedido.class); //O tipo de retorno da query
        Root<Pedido> root = criteriaQuery.from(Pedido.class);
